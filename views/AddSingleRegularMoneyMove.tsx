...
export const AddSingleRegularMoneyMove = () => {
  ...
  return (
    ...
    >
      ...
      <Typography variant="h6">Регулярность (ежемесячно)</Typography>
      <Button
        onClick={() => {
          const startDate =
            start instanceof Date && isValid(start) ? start : earliestDate;
          const endDate =
            end instanceof Date && isValid(end) ? end : latestDate;
